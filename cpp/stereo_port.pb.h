...
extern "C" {
extern const ::google::protobuf::internal::DescriptorTable descriptor_table_stereo_5fport_2eproto;
}  // extern "C"
namespace pmx {
namespace grpc {
class StereoPort;
...
extern const ::google::protobuf::internal::ClassDataFull StereoPort_class_data_;
}  // namespace grpc
}  // namespace pmx
namespace google {
namespace protobuf {
...
/* @@protoc_insertion_point(class_definition:pmx.grpc.StereoPort) */ {
 public:
  ...
  void operator delete(StereoPort* PROTOBUF_NONNULL msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  explicit PROTOBUF_CONSTEXPR StereoPort(::google::protobuf::internal::ConstantInitialized);
  ...
  inline void Swap(StereoPort* PROTOBUF_NONNULL other) {
  ...
  void UnsafeArenaSwap(StereoPort* PROTOBUF_NONNULL other) {
    if (other == this) return;
  ...
  StereoPort* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
  ...
  void InternalSwap(StereoPort* PROTOBUF_NONNULL other);
 private:
  template <typename T>
 ...
 protected:
  explicit StereoPort(::google::protobuf::Arena* PROTOBUF_NULLABLE arena);
  StereoPort(::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const StereoPort& from);
  StereoPort(
      ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, StereoPort&& from) noexcept
      : StereoPort(arena) {
    *this = ::std::move(from);
  }
 ...
 public:
  ...
  std::string* PROTOBUF_NONNULL mutable_right();
  [[nodiscard]] std::string* PROTOBUF_NULLABLE release_right();
  void set_allocated_right(std::string* PROTOBUF_NULLABLE value);

  private:
  const std::string& _internal_right() const;
  PROTOBUF_ALWAYS_INLINE void _internal_set_right(const std::string& value);
  std::string* PROTOBUF_NONNULL _internal_mutable_right();
...
PROTOBUF_ALWAYS_INLINE void StereoPort::set_left(Arg_&& arg, Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.left_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:pmx.grpc.StereoPort.left)
}
inline std::string* PROTOBUF_NONNULL StereoPort::mutable_left()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline std::string* PROTOBUF_NONNULL StereoPort::_internal_mutable_left() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000001u;
  return _impl_.left_.Mutable( GetArena());
}
inline std::string* PROTOBUF_NULLABLE StereoPort::release_left() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline void StereoPort::set_allocated_left(std::string* PROTOBUF_NULLABLE value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (value != nullptr) {
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
...
template <typename Arg_, typename... Args_>
PROTOBUF_ALWAYS_INLINE void StereoPort::set_right(Arg_&& arg, Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.right_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:pmx.grpc.StereoPort.right)
}
inline std::string* PROTOBUF_NONNULL StereoPort::mutable_right()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline std::string* PROTOBUF_NONNULL StereoPort::_internal_mutable_right() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000002u;
  return _impl_.right_.Mutable( GetArena());
}
inline std::string* PROTOBUF_NULLABLE StereoPort::release_right() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline void StereoPort::set_allocated_right(std::string* PROTOBUF_NULLABLE value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (value != nullptr) {
    _impl_._has_bits_[0] |= 0x00000002u;
  } else {
